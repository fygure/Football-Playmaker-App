        ...
        if (imageRef.current) {
            ...
            if (formationType === 'offense2x2') {
                const newShapes = [
                    ...
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'Lineman', initialPosition: { x: middlePosition.x + imageSize.width * 0.09, y: middlePosition.y + imageSize.height * 0.2 }, initialColor },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'Lineman', initialPosition: { x: middlePosition.x + imageSize.width * 0.045, y: middlePosition.y + imageSize.height * 0.2 }, initialColor },
            ...
            //FIXME: add newShapes for defense formations
                ...
                const newShapes = [
                    ...
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderC', initialPosition: { x: middlePosition.x + imageSize.width * 0.33, y: middlePosition.y + imageSize.height * 0.1 }, initialColor, text: 'C' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderE', initialPosition: { x: middlePosition.x - imageSize.width * 0.1, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'E' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderN', initialPosition: { x: middlePosition.x - imageSize.width * 0.025, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'N' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderT', initialPosition: { x: middlePosition.x + imageSize.width * 0.065, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'T' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderJ', initialPosition: { x: middlePosition.x + imageSize.width * 0.11, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'J' },
                ];
                ...
                const newShapes = [
                    ...
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderW', initialPosition: { x: middlePosition.x + imageSize.width * 0.045, y: middlePosition.y + imageSize.height * 0.075 }, initialColor, text: 'W' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderC', initialPosition: { x: middlePosition.x + imageSize.width * 0.33, y: middlePosition.y + imageSize.height * 0.1 }, initialColor, text: 'C' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderE', initialPosition: { x: middlePosition.x - imageSize.width * 0.075, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'E' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderN', initialPosition: { x: middlePosition.x + imageSize.width * 0.002, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'N' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderT', initialPosition: { x: middlePosition.x + imageSize.width * 0.075, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'T' },
                ...
                const newShapes = [
                    ...
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderE', initialPosition: { x: middlePosition.x - imageSize.width * 0.1, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'E' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderN', initialPosition: { x: middlePosition.x + imageSize.width * 0.002, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'N' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderT', initialPosition: { x: middlePosition.x + imageSize.width * 0.105, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'T' },
                ...
                const newShapes = [
                    ...
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderW', initialPosition: { x: middlePosition.x + imageSize.width * 0.002, y: middlePosition.y + imageSize.height * 0.075 }, initialColor, text: 'W' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderC', initialPosition: { x: middlePosition.x + imageSize.width * 0.33, y: middlePosition.y + imageSize.height * 0.1 }, initialColor, text: 'C' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderE', initialPosition: { x: middlePosition.x + imageSize.width * 0.105, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'E' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderN', initialPosition: { x: middlePosition.x + imageSize.width * 0.002, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'N' },
                    { key:  uuidv4(), id: uuidv4(), formationType: formationType, shapeType: 'DefenderT', initialPosition: { x: middlePosition.x - imageSize.width * 0.1, y: middlePosition.y + imageSize.height * 0.158 }, initialColor, text: 'T' },
